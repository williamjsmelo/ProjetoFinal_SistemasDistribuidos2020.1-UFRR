...
def location(update: Update, context: CallbackContext):
    ...
    banco.locais.insert_one({'latitude':current_pos[0], 'longitude':current_pos[1]})


# Conexão com o bot
updater = Updater('1445298294:AAGY8KzLwzXnK_arXysbvG8hNcj1A1OEML0')
